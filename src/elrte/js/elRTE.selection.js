...
(function($) {
    elRTE.prototype.selection = function(rte) {
        ...
        var start, end, node, bm,
            tmpStartNode, tmpStartOffset, tmpEndNode, tmpEndOffset;
        ...
        this.saveRange = function() {
            if ($.browser.msie) {
                ...
                tmpStartNode = range.startContainer;
                tmpStartOffset = range.startOffset;
                tmpEndNode = range.endContainer;
                tmpEndOffset = range.endOffset;
            }
        }

        this.restoreRange = function() {
            if ($.browser.msie) {
                bm && this.getRangeAt().moveToBookmark(bm);
            } else {
                var range = this.getRangeAt();

                range.setStart(tmpStartNode, tmpStartOffset);
                range.setEnd(tmpEndNode, tmpEndOffset);
            }
        }
        ...
        this.cloneContents = function() {
            ...
            $(this.rte).trigger('change', this.rte, this);
            return n;
        }
        ...
        this.selectContents = function(n) {
            ...
            $(this.target).trigger('change', this.rte, this);
            $(this.rte).trigger('change', this.rte, this);
            return this;
        }
        ...
        this.insertText = function(text, collapse) {
            ...
            var res = this.insertHtml(n.nodeValue);
            $(this.rte).trigger('change', this);
