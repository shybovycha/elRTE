...
(function($) {
    ...
    elRTE = function(target, opts) {
        ...
        this.original_target_attributes = this.target.getAttributes();
            ...
            .bind('keydown', function(e) {
                if ((e.metaKey || e.ctrlKey) && e.keyCode == 65) {
                    ...
                    if (self.dom.selfOrParent(n, /^PRE$/)) {
                        ...
                        return false;
                    } else if (($.browser.safari || $.browser.chrome || $.browser.webkit) && e.shiftKey) {
        ...
        if ($.browser.safari || $.browser.chrome || $.browser.webkit) {
        ...
        this.destroy = function() {
            ...
            this.target.appendTo(this.editor.parent()).setAttributes(this.original_target_attributes);
            this.editor.remove();
     ...
     * @return void
     **/
    elRTE.prototype.hideToolbar = function() {
        this.toolbar.hide();
    }
     ...
     * @return void
     **/
    elRTE.prototype.showToolbar = function() {
        this.toolbar.show();
    }
    ...
    $.fn.elrte = function(o, v) {
        ...
        this.each(function() {
            ...
            switch (cmd) {
                case 'showToolbar':
                    this.elrte.showToolbar();
                    break;
                case 'hideToolbar':
                    this.elrte.hideToolbar();
                    break;
                case 'open':
                case 'show':
                    this.elrte.open();
